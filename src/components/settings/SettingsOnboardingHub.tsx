          ...
          <div className="glass-card p-5 border-slate-200 dark:border-white/[0.06] shadow-xl">
            ...
            <div className="space-y-4 text-xs">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                <div>
                  <label className="block text-slate-600 dark:text-slate-300 font-semibold mb-1">Company Name</label>
                  <input
                    type="text"
                    value={companyName}
                ...
                <div>
                  <label className="block text-slate-600 dark:text-slate-300 font-semibold mb-1">Website URL</label>
                  <input
                    type="url"
                    value={website}
              ...
              <div>
                <label className="block text-slate-600 dark:text-slate-300 font-semibold mb-1">Business Description</label>
                <textarea
                  rows={3}
                  value={description}
                  onChange={(e) => setDescription(e.target.value)}
                  className="w-full px-3 py-2 rounded-xl bg-white dark:bg-[#080d1e] border border-slate-200 dark:border-white/[0.1] text-slate-900 dark:text-white focus:outline-none focus:border-indigo-500 leading-relaxed"
                />
              </div>
          ...
          <div className="glass-card p-5 border-slate-200 dark:border-white/[0.06] shadow-xl">
            <div className="flex items-center justify-between mb-3 pb-2 border-b border-slate-200 dark:border-white/[0.06]">
              ...
              <button
                ...
                disabled={validating}
                className="px-3 py-1.5 rounded-xl bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-500 hover:to-indigo-500 text-slate-900 dark:text-white text-xs font-bold transition-all shadow-md shadow-purple-600/30 flex items-center gap-1.5 cursor-pointer disabled:opacity-50"
              >
                {validating ? (
                  <>
            ...
            {validationResult && (
              <div className="p-4 rounded-xl bg-white dark:bg-[#070b1c] border border-emerald-500/30 space-y-2">
        ...
        <div className="lg:col-span-5 space-y-6">
          ...
          <div className="glass-card p-5 border-slate-200 dark:border-white/[0.06] shadow-xl">
            ...
            <div className="space-y-2.5 text-xs">
              ...
              >
                ...
                />
                <div>
                  <div className="font-bold text-slate-900 dark:text-white">Platform Built-In Voice Service</div>
              ...
              >
                ...
                />
                <div>
                  <div className="font-bold text-slate-900 dark:text-white">Bring Your Own Telephony (BYOT / Twilio)</div>
                  <div className="text-[11px] text-slate-600">
          ...
          <div className="glass-card p-5 border-slate-200 dark:border-white/[0.06] shadow-xl">
            ...
            <div className="space-y-3.5 text-xs">
              <div>
                <label className="block text-slate-600 dark:text-slate-300 font-semibold mb-1">Persona Name &amp; Role</label>
                <input
                  type="text"
                  value={aiPersonaName}
              ...
              <div>
                <label className="block text-slate-600 dark:text-slate-300 font-semibold mb-1">Default Conversational Language</label>
                <select
              ...
              <div>
                <label className="block text-slate-600 dark:text-slate-300 font-semibold mb-1">Tone &amp; Conversational Style</label>
                <div className="grid grid-cols-3 gap-2 text-[11px] text-center">
                  <div className="p-2 rounded-lg bg-indigo-600/20 text-indigo-300 border border-indigo-500/30 font-bold">
                    Professional
                  </div>
                  <div className="p-2 rounded-lg bg-white/[0.03] text-slate-600 border border-slate-200 dark:border-white/[0.05]">
                    Consultative
                  </div>
                  <div className="p-2 rounded-lg bg-white/[0.03] text-slate-600 border border-slate-200 dark:border-white/[0.05]">
                    Energetic
