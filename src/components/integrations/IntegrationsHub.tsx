        ...
        {integrations.map((service) => (
          ...
          >
                ...
                <span
                  className={`px-2 py-0.5 rounded text-[10px] font-bold border ${
                    service.connected
                      ...
                      : 'bg-slate-700/40 text-slate-600 border-slate-200 dark:border-white/[0.08]'
                  }`}
                >
            ...
            <div className="pt-3 border-t border-slate-200 dark:border-white/[0.06] flex items-center justify-between">
              <span className="text-[11px] text-slate-700 font-medium">{service.category}</span>
              <button
                onClick={() => handleToggleConnect(service.id)}
                className={`px-3 py-1.5 rounded-lg text-xs font-semibold transition-all cursor-pointer ${
                  service.connected
                    ? 'bg-white/[0.05] hover:bg-rose-500/20 text-slate-600 dark:text-slate-300 hover:text-rose-300 border border-slate-200 dark:border-white/[0.08]'
        ...
        <div className="glass-card p-5 border-slate-200 dark:border-white/[0.06] shadow-xl">
          ...
          <div className="flex items-center gap-2">
            <input
              ...
              className="flex-1 px-3 py-2 rounded-xl bg-white dark:bg-[#090d1f] border border-slate-200 dark:border-white/[0.08] text-xs text-slate-600 dark:text-slate-300 font-mono"
            />
            <button
              onClick={copyApiKey}
        ...
        <div className="glass-card p-5 border-slate-200 dark:border-white/[0.06] shadow-xl">
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              className="px-3 py-2 rounded-xl bg-white/[0.05] hover:bg-white/[0.1] text-slate-700 dark:text-slate-200 text-xs font-semibold transition-all cursor-pointer"
            >
              Test Ping
            </button>
          </div>
