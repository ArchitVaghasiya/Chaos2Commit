  ...
  return (
    <div className="flex flex-col items-center">
      ...
      <div className="w-full max-w-[280px] rounded-[38px] p-3 bg-gradient-to-b from-slate-700 via-slate-800 to-slate-950 shadow-2xl border-4 border-slate-700 relative overflow-hidden">
        {/* Device Bezel & Screen */}
        <div className="w-full rounded-[28px] bg-[#070b1c] text-white p-3.5 flex flex-col justify-between min-h-[510px] text-xs relative overflow-hidden border border-white/[0.08]">
          ...
          <div className="flex items-center justify-between mb-3">
            <div>
              ...
              <div className="text-[10px] text-slate-400">Here&apos;s your sales overview</div>
            </div>
          ...
          <div className="p-2.5 rounded-xl bg-white/[0.04] border border-white/[0.08] mb-3">
            <div className="flex items-center justify-between mb-1.5">
              <span className="text-[10px] text-slate-400 font-medium">Active Campaign</span>
          ...
          <div className="grid grid-cols-4 gap-1.5 mb-3 text-center">
            <div className="p-1.5 rounded-lg bg-white/[0.03] border border-white/[0.04]">
              ...
              <div className="text-[8px] text-slate-400">Calls</div>
              <div className="text-[10px] font-bold text-white">1,256</div>
            </div>

            <div className="p-1.5 rounded-lg bg-white/[0.03] border border-white/[0.04]">
              <MessageSquare className="w-2.5 h-2.5 mx-auto text-purple-400 mb-0.5" />
              <div className="text-[8px] text-slate-400">Conversations</div>
              <div className="text-[10px] font-bold text-white">632</div>
            </div>

            <div className="p-1.5 rounded-lg bg-white/[0.03] border border-white/[0.04]">
              <Heart className="w-2.5 h-2.5 mx-auto text-amber-400 mb-0.5" />
              <div className="text-[8px] text-slate-400">Interested</div>
              <div className="text-[10px] font-bold text-white">198</div>
            </div>

            <div className="p-1.5 rounded-lg bg-white/[0.03] border border-white/[0.04]">
              <Calendar className="w-2.5 h-2.5 mx-auto text-emerald-400 mb-0.5" />
              <div className="text-[8px] text-slate-400">Meetings</div>
          ...
          <div className="mb-2">
            <div className="flex items-center justify-between text-[10px] text-slate-400 mb-1.5 px-0.5">
            ...
            <div className="space-y-1.5 text-[9px]">
              <div className="p-1.5 rounded-lg bg-white/[0.02] border border-white/[0.04] flex items-center justify-between">
                <div>
                ...
                <span className="text-[8px] text-slate-400">2 min ago</span>
              </div>
              ...
              <div className="p-1.5 rounded-lg bg-white/[0.02] border border-white/[0.04] flex items-center justify-between">
                ...
                <span className="text-[8px] text-slate-400">15 min ago</span>
              </div>
              ...
              <div className="p-1.5 rounded-lg bg-white/[0.02] border border-white/[0.04] flex items-center justify-between">
                <div>
                  ...
                  <div className="text-slate-400 font-semibold">No Answer – Retry Scheduled</div>
                </div>
                <span className="text-[8px] text-slate-400">30 min ago</span>
              </div>
            </div>
          </div>

          {/* Bottom Mobile Tab Bar */}
          <div className="pt-2 border-t border-white/[0.08] grid grid-cols-5 text-center text-[8px] text-slate-400">
