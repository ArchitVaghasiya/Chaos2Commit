...
export default function CapabilitiesFooter() {
  ...
  return (
    <footer className="mt-8 pt-6 pb-4 border-t border-white/[0.08]">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-4">
        {capabilities.map((cap, i) => {
          ...
          return (
            <div
              key={i}
              className="p-3.5 rounded-xl bg-white/[0.02] border border-white/[0.04] hover:bg-white/[0.04] hover:border-white/[0.08] transition-all flex items-start gap-3"
            >
      ...
      <div className="mt-6 pt-4 border-t border-white/[0.04] flex flex-col sm:flex-row items-center justify-between text-xs text-slate-400 gap-2">
        ...
        <div className="flex items-center gap-4 text-[11px]">
          ...
          <span>•</span>
          <span className="hover:text-slate-300 transition-colors">Security &amp; Compliance</span>
          <span>•</span>
